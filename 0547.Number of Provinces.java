class Solution {
    /*
        dfs.
        Detect how many partitions in the graph.
        check each node, if it is not visited, dfs it and mark all reachable node to visited
        count the number of unvisited parts.
        O(n^2 + n);
    */
